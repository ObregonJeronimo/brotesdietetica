...
t('el lector reconoce las etiquetas del local',
  /if \(typeof etiquetaProductoDe === 'function'\) return etiquetaProductoDe\(cod, allProducts\)/.test(lector));
t('pero el codigo de fabrica sigue teniendo prioridad',
  lector.indexOf('const deFabrica = allProducts.find') <
  lector.indexOf('etiquetaProductoDe(cod, allProducts)'));
